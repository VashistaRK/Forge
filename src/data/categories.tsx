...
export const categories: Record<string, Category> = {
  Professional: {
    icon: <FaBriefcase className="text-blue-500 text-3xl" />, // ✅ Now correctly typed
  ...
  Modern: {
    icon: <FaGlasses className="text-orange-500 text-3xl" />,
    gradient:
  ...
  Creative: {
    icon: <FaRegLightbulb className="text-green-500 text-3xl" />,
  ...
  Picture: {
    icon: <FaUserCircle className="text-purple-500 text-3xl" />,
  ...
  "Google Docs": {
    icon: <FaGoogle className="text-yellow-500 text-3xl" />,
    gradient:
  ...
  "Microsoft Word": {
    icon: <FaFileWord className="text-orange-500 text-3xl" />,
